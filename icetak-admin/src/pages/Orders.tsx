...
function OrderDrawer({ detail, loading, permissions, busyId, onClose, onReload, onAction, onWhatsapp, onCopy }: {
  ...
  const saveRecipient = async () => {
    if (!order || !recipientComplete || recipientLocked) return;
