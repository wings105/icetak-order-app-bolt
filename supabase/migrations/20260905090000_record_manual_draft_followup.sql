...
revoke all on function public.icetak_admin_record_manual_draft_followup(uuid,text,text,text) from public,anon,authenticated;
grant execute on function public.icetak_admin_record_manual_draft_followup(uuid,text,text,text) to service_role;
